                  ...
                  tiles: [
                    {
                      ...
                      properties: {
                        title: "App Title",
                        targetURL:
                          "#comsmodcontrolsratingcustomcontrolrating-display",
                      },
                    },
                  ],
                },
        ...
        ClientSideTargetResolution: {
          adapter: {
            config: {
              inbounds: {
                "comsmodcontrolsratingcustomcontrolrating-display": {
                  semanticObject: "comsmodcontrolsratingcustomcontrolrating",
                  action: "display",
                  ...
                  resolutionResult: {
                    ...
                    additionalInformation: "SAPUI5.Component=com.smod.controls",
                    url: sap.ui.require.toUrl("com/smod/controls"),
                  },
                },
              },
            },
